 ...
 */
import { AddFkAuditLogTypeAction1779100000130 } from '../../src/migrations/1779100000130-AddFkAuditLogTypeAction';
import { AddFkDimCompteClasse1779100000050 } from '../../src/migrations/1779100000050-AddFkDimCompteClasse';
import { AddFkDimCompteSens1779100000040 } from '../../src/migrations/1779100000040-AddFkDimCompteSens';
import { AddFkDimCrTypeCr1779100000030 } from '../../src/migrations/1779100000030-AddFkDimCrTypeCr';
import { AddFkDimProduitTypeProduit1779100000060 } from '../../src/migrations/1779100000060-AddFkDimProduitTypeProduit';
import { AddFkDimScenarioStatut1779100000110 } from '../../src/migrations/1779100000110-AddFkDimScenarioStatut';
import { AddFkDimScenarioTypeScenario1779100000100 } from '../../src/migrations/1779100000100-AddFkDimScenarioTypeScenario';
import { AddFkDimSegmentCategorie1779100000070 } from '../../src/migrations/1779100000070-AddFkDimSegmentCategorie';
import { AddFkDimStructureCodePays1779100000020 } from '../../src/migrations/1779100000020-AddFkDimStructureCodePays';
import { AddFkDimStructureTypeStructure1779100000010 } from '../../src/migrations/1779100000010-AddFkDimStructureTypeStructure';
import { AddFkDimVersionStatut1779100000090 } from '../../src/migrations/1779100000090-AddFkDimVersionStatut';
import { AddFkDimVersionTypeVersion1779100000080 } from '../../src/migrations/1779100000080-AddFkDimVersionTypeVersion';
import { AddFkRefTauxChangeTypeTaux1779100000120 } from '../../src/migrations/1779100000120-AddFkRefTauxChangeTypeTaux';
